...
import room from '../../images/shop.png';
function Shop() {
    return (
        <Container>
            <div className={styles.shop}>

                <svg className={styles.arrowLeft} xmlns="http://www.w3.org/2000/svg" width="27" height="53" viewBox="0 0 27 53" fill="none">
                ...
                <img className={styles.roome} src={room} alt="" />

                <div className={styles.shop_logo}>

                    <p className={styles.shop_h1}>Get ready for Our <br /> stylist chair</p>

                    <button className={styles.shop_logo_btn}>SHOP NOW</button>
                </div>

                <svg className={styles.arrowRight} xmlns="http://www.w3.org/2000/svg" width="27" height="53" viewBox="0 0 27 53" fill="none">
